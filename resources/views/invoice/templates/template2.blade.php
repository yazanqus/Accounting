                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,($invoice->getTotal()-$invoice->getDue())-($invoice->invoiceTotalCreditNote()))}}</div>
                                                </div>
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    <div data-v-f2a183a6="" class="d-table-label">{{__('Credit Note')}}:</div>
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,($invoice->invoiceTotalCreditNote()))}}</div>
                                                </div>
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
