...
@section('content')
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td class="text-right totalAmount blue-text border-none">0.00</td>
                                <td></td>
                            </tr>
                            </tfoot>
                        </table>
        ...
        <div class="col-12 text-right">
            ...
            <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("proposal.index")}}';" class="btn-create btn-xs bg-gray radius-10px">
        </div>
        {{ Form::close() }}
    </div>
@endsection
